...
#define MODEL	MODEL_DEBUG

#if (MODEL==MODEL_LUACH)

#define ADR_BLUE	"/sys/class/leds/blue/brightness.txt"

#define ADR_RED		"/sys/class/leds/red/brightness.txt"

#define ADR_GREEN	"/sys/class/leds/green/brightness.txt"
